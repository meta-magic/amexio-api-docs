webpackJsonp(["gauge.demo.module"],{

/***/ "../../../../../src/app/dashboard/gauge/gauge.demo.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GaugeDemoComponent; });
...
var GaugeDemoComponent = (function () {
    function GaugeDemoComponent(http) {
        this.http = http;
        this.gaugeChartData = [
            ['Label', 'Value'],
            ['Memory', 80],
    ...
    GaugeDemoComponent.prototype.getHtmlAndTypeScriptCode = function () {
        var _this = this;
        var responseHtml;
        var responseTs;
        //HTML FILE
        this.http.get('assets/data/code/dashboard/gauge/chart.html').subscribe(function (data) {
        ...
        //TS FILE
        this.http.get('assets/data/code/dashboard/gauge/chart.text').subscribe(function (data) {
        ...
        //DataSource FILE
        this.http.get('assets/data/code/dashboard/gauge/datasource.json').subscribe(function (data) {
            responseTs = data.text();
        }, function (error) {
        }, function () {
    ...
    GaugeDemoComponent.prototype.onCopyClick = function () {
    ...
    GaugeDemoComponent.prototype.ngOnInit = function () {
    };
...
/***/ "../../../../../src/app/dashboard/gauge/gauge.demo.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GaugeDemoModule", function() { return GaugeDemoModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__gauge_demo_component__ = __webpack_require__("../../../../../src/app/dashboard/gauge/gauge.demo.component.ts");
...
var GaugeDemoModule = (function () {
    function GaugeDemoModule() {
    }
    GaugeDemoModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_5__angular_core__["J" /* NgModule */])({
            declarations: [__WEBPACK_IMPORTED_MODULE_6__gauge_demo_component__["a" /* GaugeDemoComponent */]],
            imports: [__WEBPACK_IMPORTED_MODULE_4__angular_common__["b" /* CommonModule */], __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_2__angular_http__["c" /* HttpModule */], __WEBPACK_IMPORTED_MODULE_1_amexio_ng_extensions__["h" /* AmexioWidgetModule */], __WEBPACK_IMPORTED_MODULE_7__shared_module__["a" /* SharedModule */], __WEBPACK_IMPORTED_MODULE_1_amexio_ng_extensions__["b" /* AmexioDashBoardModule */], __WEBPACK_IMPORTED_MODULE_0__angular_router__["d" /* RouterModule */].forChild([{
                        path: '', component: __WEBPACK_IMPORTED_MODULE_6__gauge_demo_component__["a" /* GaugeDemoComponent */], pathMatch: 'full'
                    }])],
            providers: []
        })
    ], GaugeDemoModule);
    return GaugeDemoModule;
}());
...
//# sourceMappingURL=gauge.demo.module.chunk.js.map