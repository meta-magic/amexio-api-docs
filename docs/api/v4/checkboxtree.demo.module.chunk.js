webpackJsonp(["checkboxtree.demo.module"],{
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__checkboxtree_demo__ = __webpack_require__("../../../../../src/app/data/tree/checkboxtree/checkboxtree.demo.ts");
 ...
 */
var CheckboxTreeDemoModule = (function () {
    function CheckboxTreeDemoModule() {
    }
    CheckboxTreeDemoModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            declarations: [__WEBPACK_IMPORTED_MODULE_7__checkboxtree_demo__["a" /* CheckboxTreeDemo */]],
            imports: [__WEBPACK_IMPORTED_MODULE_5__angular_common__["b" /* CommonModule */], __WEBPACK_IMPORTED_MODULE_4__angular_forms__["a" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_3__angular_http__["c" /* HttpModule */], __WEBPACK_IMPORTED_MODULE_6__shared_module__["a" /* SharedModule */], __WEBPACK_IMPORTED_MODULE_2_amexio_ng_extensions__["h" /* AmexioWidgetModule */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["d" /* RouterModule */].forChild([{
                        path: '', component: __WEBPACK_IMPORTED_MODULE_7__checkboxtree_demo__["a" /* CheckboxTreeDemo */], pathMatch: 'full'
                    }])],
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CheckboxTreeDemo; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
...
var CheckboxTreeDemo = (function () {
    ...
    CheckboxTreeDemo.prototype.getHtmlAndTypeScriptCode = function () {
        ...
        var responseTs;
        //HTML FILE
        this.http.get('assets/data/code/data/tree/checkboxtree/checkboxtree.html').subscribe(function (data) {
        ...
        //TS FILE
        this.http.get('assets/data/code/data/tree/checkboxtree/checkboxtree.text').subscribe(function (data) {
            responseTs = data.text();
        }, function (error) {
        }, function () {
            _this.typeScriptCode = responseTs;
        });
        this.http.get('assets/data/componentdata/treeview.json').subscribe(function (data) {
            responseTs = data.text();
        }, function (error) {
        }, function () {
...
//# sourceMappingURL=checkboxtree.demo.module.chunk.js.map