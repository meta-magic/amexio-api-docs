webpackJsonp(["groupbygrid.demo.module"],{

/***/ "../../../../../src/app/data/groupby/groupbygrid.demo.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GroupByGridDemoModule", function() { return GroupByGridDemoModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__groupbygrid_demo__ = __webpack_require__("../../../../../src/app/data/groupby/groupbygrid.demo.ts");
 ...
 */
var GroupByGridDemoModule = (function () {
    function GroupByGridDemoModule() {
    }
    GroupByGridDemoModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            declarations: [__WEBPACK_IMPORTED_MODULE_7__groupbygrid_demo__["a" /* GroupByGridDemo */]],
            imports: [__WEBPACK_IMPORTED_MODULE_5__angular_common__["b" /* CommonModule */], __WEBPACK_IMPORTED_MODULE_4__angular_forms__["a" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_3__angular_http__["c" /* HttpModule */], __WEBPACK_IMPORTED_MODULE_6__shared_module__["a" /* SharedModule */], __WEBPACK_IMPORTED_MODULE_2_amexio_ng_extensions__["h" /* AmexioWidgetModule */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["d" /* RouterModule */].forChild([{
                        path: '', component: __WEBPACK_IMPORTED_MODULE_7__groupbygrid_demo__["a" /* GroupByGridDemo */], pathMatch: 'full'
                    }])],
            providers: []
        })
    ], GroupByGridDemoModule);
    return GroupByGridDemoModule;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GroupByGridDemo; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
...
var GroupByGridDemo = (function () {
    function GroupByGridDemo(http) {
        this.http = http;
        this.getHtmlAndTypeScriptCode();
    }
    //TO LOAD HTML AND TYPESCRIPT CODE
    GroupByGridDemo.prototype.getHtmlAndTypeScriptCode = function () {
        var _this = this;
        var responseHtml;
        var responseTs;
        //HTML FILE
        this.http.get('assets/data/code/data/groupby/groupby.html').subscribe(function (data) {
        ...
        //TS FILE
        this.http.get('assets/data/code/data/groupby/groupby.text').subscribe(function (data) {
            responseTs = data.text();
        }, function (error) {
        }, function () {
            _this.typeScriptCode = responseTs;
        });
        this.http.get('assets/data/componentdata/datagridgroupby.json').subscribe(function (data) {
            responseTs = data.text();
        }, function (error) {
        }, function () {
...
//# sourceMappingURL=groupbygrid.demo.module.chunk.js.map